 ...
 * @copyright CiviCRM LLC (c) 2004-2015
 *
 * Generated from xml/schema/CRM/Newsstore/NewsSource.xml
 * DO NOT EDIT.  Generated by CRM_Core_CodeGen
 */
require_once 'CRM/Core/DAO.php';
require_once 'CRM/Utils/Type.php';
class CRM_Newsstore_DAO_NewsSource extends CRM_Core_DAO {
  /**
   * static instance to hold the table name
   *
   * @var string
   */
  static $_tableName = 'civicrm_newssource';
  /**
  ...
  static $_log = true;
  /**
   * Unique NewsSource ID
   *
   * @var int unsigned
   */
  public $id;
  /**
   * Human name to identify this NewsSource used in administrative interface.
   *
   * @var string
   */
  public $name;
   ...
   * class constructor
   *
   * @return civicrm_newssource
   */
  function __construct() {
    $this->__table = 'civicrm_newssource';
    parent::__construct();
  }
  /**
    ...
    if (!(self::$_fields)) {
      self::$_fields = array(
        'id' => array(
          ...
          'description' => 'Unique NewsSource ID',
          'required' => true,
        ) ,
        'name' => array(
          'name' => 'name',
          ...
          'title' => ts('Name') ,
          'description' => 'Human name to identify this NewsSource used in administrative interface.',
          'required' => true,
          'maxlength' => 255,
    ...
    if (!(self::$_import)) {
      ...
      foreach($fields as $name => $field) {
        if (CRM_Utils_Array::value('import', $field)) {
          if ($prefix) {
            self::$_import['newssource'] = & $fields[$name];
          } else {
    ...
    if (!(self::$_export)) {
      ...
      foreach($fields as $name => $field) {
        if (CRM_Utils_Array::value('export', $field)) {
          if ($prefix) {
            self::$_export['newssource'] = & $fields[$name];
          } else {
